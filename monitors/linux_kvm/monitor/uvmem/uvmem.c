...
static struct file_operations uvmem_fops = {
	...
	// liang: try to make it work for 32bit process on a 64bit kernel
	.compat_ioctl = uvmem_ioctl, // it's dangerous because I didn't do any 32->64 bit conversion.
	.mmap		= uvmem_mmap,
	.poll		= uvmem_poll,
	.read		= uvmem_read,
	.write		= uvmem_write,
